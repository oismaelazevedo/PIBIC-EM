...
while k < 100:
    ...
    questoes = open("questao{}-238a.json".format(k+1), 'w')

    numBaseLogaritmo = rnd.randint(2,1000)

    valX1 = rnd.randint(2,100)
    valX2 = rnd.randint(2,100)

    valNum01 = rnd.randint(2,1000)
    valNum02 = rnd.randint(2,1000)

    while(valX1 == valX2 or valNum01 == valNum02):
        valX1 = rnd.randint(2,100)
        valX2 = rnd.randint(2,100)
    ...
    resposta = round((valNum02 - valNum01)/(valX1 - valX2), 2) 
        ...
        for numLetra in range(0,5):
            if questaoCerta == listLetra[numLetra]:
                ...
                if numRandomTemporario == 0:
                    ...
                    listAlternativas[numLetra] = round((valX2 - valX1)/(valNum01 - valNum02), 2) 
                ...
                if numRandomTemporario == 0:
                    ...
                    listAlternativas[numLetra] = round((rnd.randint(2,1000) - rnd.randint(2,1000))/rnd.randint(2,100),2)
                    isCorrect[numLetra] = "Nao"
    ...
    dados = {
        ...
        'atributosquestao': [
            {
                'enunciado': 'Resolva a equação: a) log{} ({}x + {}) = log{} ({}x + {})'.format(numBaseLogaritmo,valX1,valNum01,numBaseLogaritmo,valX2,valNum02),
    ...
    if dados['atributosquestao'][0]['enunciado'] in enunciado:
        ...
        print('Resolva a equação: a) log{} ({}x + {}) = log{} ({}x + {})'.format(numBaseLogaritmo,valX1,valNum01,numBaseLogaritmo,valX2,valNum02))
