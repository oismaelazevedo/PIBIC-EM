...
<body>
    ...
    if (!empty($_POST["letra"])) {
        ...
        (:rodada, :id_usuario, :arquivo, :letra_resp_user, :letra_correta, :secorreta, :tipoerro, :obs, :tempo_gasto, :ip, :qtdAleatoriaPositiva, :qtdAleatoriaNegativa,:qtdInvertidaPositiva,:qtdInvertidaNegativa)";
