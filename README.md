...
| 135 - j | Calcule pela definição os seguintes logaritmos: j) log<sub>0,25</sub> 8 | Calcule pela definição os seguintes logaritmos: log<sub><número_aleatório></sub> (<número_aleatório>) | Livro Fundamentos de Matemática Elementar - Vol. 02 |
